...
const messages = {
  zh: {
    ...
    compareVersions: '对比所有版本',
    forkConversation: '分支',
    forkedBanner: '您已在分支后的对话中',
    backToChat: '返回对话',
    selectModel: '选择模型',
    ...
    assistants: '助手',
    noAssistant: '无助手',
    assistantLocked: '发送首条用户消息后，当前对话的 Assistant 绑定将锁定。',
    newAssistant: '+ 新助手',
    loading: '加载中...',
  ...
  en: {
    ...
    compareVersions: 'Compare all versions',
    forkConversation: 'Branch',
    forkedBanner: 'You are in a branched conversation',
    ...
    noAssistant: 'None',
    assistantLocked: 'Assistant binding is locked after the first user message in this conversation.',
    newAssistant: '+ New Assistant',
    loading: 'Loading...',
    noAssistantsYet: 'No assistants yet',
    modelCombos: 'Model Combos',
    teamAnswer: 'Team Answer',
    selectCombo: 'Select model combo',
    manageCombo: 'Manage Combos',
    addCombo: 'New Combo',
    comboName: 'Combo Name',
    comboModels: 'Models',
    noCombo: 'No combos yet',
    generating: 'Generating',
    comboActive: 'Team Mode',
    newChat: '+ New Chat',
